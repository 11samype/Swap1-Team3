...
public class Day implements Serializable{
	/*
     * SWAP 1, TEAM ?? (JORDON/FRANCIS)
     * SMELL: Lazy Class - This class really doesn't do anything aside from
     * 	storing a few strings.
     * FIX: This class could take on more responsibility for the GUI. Holding
     * 	references to the elements plagued by data clumps in Config would go
     * 	a long way.
     */
